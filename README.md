...
and linking all succeed with no errors — and a 154-test unit test suite
...
154/154 tests passing as of this writing. See [`TESTING.md`](TESTING.md) for
...
│   │                    tabbed Info/Cast & Crew/Details area
