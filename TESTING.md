...
`slowLogoImage`, `slowSubtitleFonts`, `showWithoutEpisodes` and
`customHTTPPort`.
...
`UITestServerDiscovery`, which answers every scan with the stub server
