...
**Verified:** the full suite (414 tests) has been run for real via
...
- **`AetherPlaybackEngine`** itself — still untestable in the traditional
  ...
  `descriptiveName`, `metadataLabel`, `makeExternalSubtitleTrack` — HDR
  format labels, and the track
